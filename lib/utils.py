...
REQUIRED_ENV = ['TOKEN', 'DATABASE_URL', 'DATABASE_NAME', 'SHUTDOWN_PASSWORD0', 'DEBUG_GUILD_ID', 'POLL_CHANNEL_ID', 'ANNOUNCEMENTS_CHANNEL_ID', 'BOT_CATEGORY_ID', 'EVENTS', 'SLOWMODE', 'POLLS', "UTILS"]
